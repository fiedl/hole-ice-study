...
OptionParser.new do |opts|
  ...
  opts.on "--cable", "Simulate the main cable as instant-absorption cylinders." do
    options[:cable] = true
  end
...
photon_frames_options = {
  ...
  angles: options[:angles] || [0,10,20,30,40,50,60,70,90,120,140,150,160,170,180],
...
if options[:cluster]
  log.warning "Skipping README because running on the cluster. For configuration, see options.txt."
else
