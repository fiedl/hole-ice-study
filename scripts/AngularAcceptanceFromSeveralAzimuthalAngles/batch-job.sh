...
REMOTE="$SCRATCH/hole-ice-study/scripts/AngularAcceptanceFromSeveralAzimuthalAngles"
...
for folder in AngularAcceptanceFromSeveralAzimuthalAngles AngularAcceptance lib; do
...
# Execute script.
cd $TMPDIR/AngularAcceptanceFromSeveralAzimuthalAngles
ruby --version
bundle install
