...
mkdir -p "$TMPDIR/ParameterScan" "$TMPDIR/AngularAcceptance"
cd "$SCRATCH/hole-ice-study/scripts/ParameterScan"
cp Gemfile Gemfile.lock run.rb $TMPDIR/ParameterScan/
